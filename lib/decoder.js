    ...
    case 0x08: // audio
      ...
      if (soundFormat == 10) {
        ...
        if (0 == aacType) {
          ...
          console.error(_aacProfile, _sampleRateIndex, _channelConfig);
          ...
          process.stdout.write(adts);
          process.stdout.write(audioData);
        }
      } else {
        // the raw audio data Buffer (MP3 data or whatever...)
        this.currentTag.audioData = buf.slice(1);
        //this.emit('audio', this.currentTag);
      }
